...
# Since the orchestrator provides the built LangGraph application, 
# we inject it into the use case or import it directly.
class QueryRagBedrockUseCase(QueryRagUseCase):
